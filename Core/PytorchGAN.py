        ...
        for idx, batch in enumerate(dataloader):
            ...
            if idx in fid_batch:
                with torch.no_grad():
                    ...
                    self.fid.update(fake_images_8b.expand((fake_images_8b.shape[0], 3, fake_images_8b.shape[2], fake_images_8b.shape[3])), real=False)
                    self.fid.update(batch_x_8b.expand((batch_x_8b.shape[0], 3, batch_x_8b.shape[2], batch_x_8b.shape[3])), real=True)
